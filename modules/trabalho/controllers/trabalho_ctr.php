...
/*****************************************************************
  ...
  public function gerar_pdf($id_trabalho) {
    ...
    $var_html = $this->load->view('css2.html.php', $data, true);
    $var_html = $var_html.$this->load->view('logo_pdf2.html.php', $data, true);
    $var_html = $var_html.$this->load->view('tela_pdf.html.php', $data, true);
    $var_html = $var_html.('
    </div>
  </body>
</html>');
    //$this->load->view('tela_pdf.html.php', $data);
  ...
  $dompdf->stream("Trabalho_".$trabalho->id_trabalho.".pdf", array("Attachment" => false));
