<?php
    $status_pdf = "";
        if($trabalho->status == 4){
        $status_pdf = "aceito";
    }else{
        $status_pdf = "em análise";
    }
?>

        <td class="trab_ac_pdf" align="right" width="83%">
            <span>Trabalho <?php echo $status_pdf;?> para apresentação na 16ª Mostra de Pesquisa, 
    ...
    <div class="trabalho_pdf">
      <p class = "trab_ac_pdf">
        Trabalho número: <b><span><?php echo $trabalho->id_trabalho; ?></span></b>
      </p>
    </div>
